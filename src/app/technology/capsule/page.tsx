...
import { techBgDesktop, techBgTablet, techBgMobile, spaceCap, spaceCapSm } from "@/assets";
    ...
    <div className={``}>
      ...
      <div className="tab:mx-40 mob:mx-12 mx-auto tab:mt-[5.5rem] mob:mt-6">
        <div className="absolute right-0 mt-7 tab:flex hidden z-[-1]">
          <Image src={spaceCap} alt="image of a rocket taking off" className=""/>
        </div>
        <div>
        ...
        <div className="absolute tab:mt-7 mob:mt-14 mt-8 max-tab:flex hidden left-0 z-[-1]">
          <Image src={spaceCapSm} alt="image of a rocket taking off" className="relative"/>
        </div>
        <div className="tab:mt-32 flex flex-row mob:mt-[28rem] mt-56 max-tab:flex-col">
          <div className="flex tab:flex-col max-tab:flex-row max-tab:items-center max-tab:justify-between max-tab:w-[210px] max-mob:w-[152px] max-tab:self-center">
            ...
            <Link href="/technology/capsule" className="tab:w-[80px] tab:h-[80px] mob:w-[60px] mob:h-[60px] w-[40px] h-[40px] rounded-full bg-white tab:mt-6 flex items-center justify-center cursor-pointer">
              <p className={`${bellefair.className} tab:text-[32px] tab:tracking-[2px] tab:leading-[37px] mob:text-[24px] mob:tracking-[1.5px] mob:leading-[27.5px] text-[16px] tracking-[1px] leading-[18px] text-black`}>3</p>
            </Link>
          </div>
