...
import { destBgDesktop, destBgTablet, destBgMobile, europa } from "@/assets";
...
export const metadata: Metadata = {
    title: 'OuterWorld | Destination | Europa',
    description: 'Come explore the world beyond with us!',
}

const [, , thirdDestination] = destination;
      ...
      <div className="tab:mx-40 mob:mx-12 mx-auto tab:mt-[5.5rem] mob:mt-6">
        ...
        <div className="mt-14 max-mob:mt-4 flex tab:flex-row flex-col justify-between">
          <div className="tab:ml-16 mx-auto">
            <Image src={europa} alt="a picture of the Europa" className="tab:w-[445px] tab:h-[445px] mob:w-[300px] mob:h-[300px] w-[170px] h-[170px]"/>
          </div>
          <div className="flex flex-col tab:max-w-[445px] tab:mt-0 mob:mt-14 mt-6 tab:text-left text-center max-tab:justify-center">
            <Nav />
            <div className="">
                <Heading type={"heading2"} className={`${bellefair.className} uppercase mob:mt-8 mt-6`}>{thirdDestination.name}</Heading>
                <Paragraph className={`${barlow.className} mob:mt-3 mt-2 max-mob:mx-6`}>{thirdDestination.description}</Paragraph>
                ...
                <div className="flex mob:flex-row flex-col justify-center tab:justify-start">
                  <div className="flex flex-col mob:mt-6 mt-7">
                    ...
                    <Heading type={"distance"} className="mt-2 uppercase">{thirdDestination.distance}</Heading>
                  </div>
                  <div className="flex flex-col mob:mt-6 mt-7 mob:ml-24">
                    ...
                    <Heading type={"distance"} className="mt-2 uppercase">{thirdDestination.travel}</Heading>
                  </div>
                </div>
            </div>
          </div>
