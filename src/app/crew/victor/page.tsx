...
import { crewBgDesktop, crewBgTablet, crewBgMobile, victor } from "@/assets";
      ...
      <div className="tab:mx-40 mob:mx-12 mx-auto tab:mt-[5.5rem] mob:mt-6 flex tab:flex-row flex-col tab:justify-between justify-center">
        <div>
          ...
          <div className="mob:hidden mt-6 flex justify-center">
            <Image src={victor} alt="picture of a person" className="w-[154px] h-[222px]" />
          </div>
          ...
          <div className="tab:mt-32 mob:mt-10 mt-8 max-tab:text-center flex flex-col max-tab:justify-center">
            <div className="max-mob:order-last max-mob:mt-8">
              ...
              <div className="max-tab:flex max-tab:justify-center">
                <Paragraph className={`${barlow.className} tab:mt-6 mt-4 text-[#D0D6F9] tab:w-[444px] mob:w-[592px] w-[327px]`}>{bio}</Paragraph>
              </div>
            </div>
            <div className="tab:mt-8 mob:mt-10 flex flex-row max-tab:justify-center max-mob:order-first">
              ...
              <Link href="/crew/victor" className="w-[15px] h-[15px] rounded-full bg-white mr-6 hover:bg-[#85868b]" />
              <Link href="/crew/anousheh" className="w-[15px] h-[15px] rounded-full bg-white opacity-[0.17] hover:bg-[#85868b]" />
            </div>
          </div>
        </div>
        <div className="tab:mt-[4.5rem] mob:mt-[4.5rem] max-tab:mx-auto mob:flex hidden">
          <Image src={victor} alt="picture of a person" className="tab:w-auto tab:h-auto mob:w-[433px] mob:h-[532px] w-[181px] h-[222px]" />
        </div>
      </div>
    </div>
  )
